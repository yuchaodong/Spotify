// Pseudocode: (* Recursion)
  ...
  // create variables that keep track of: current, count
  // example: amount = 4, denomination = [1, 2, 3]
    // is 3 more than half of 4? Yes (do not add itself)
    // is 3 + 1 = 4? Yes (increment count (count = 1, current = 3 ), move to next largest denomination, because 3 + 1 is === 4 (not more, not less))
